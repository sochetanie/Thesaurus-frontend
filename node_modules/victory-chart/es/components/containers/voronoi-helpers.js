...
var VoronoiHelpers = {
  ...
  onMouseMove: function (evt, targetProps) {
    ...
    if (activePoints.length && _isEqual(points, activePoints)) {
...
export default {
  ...
  onMouseMove: _throttle(attachId(VoronoiHelpers.onMouseMove.bind(VoronoiHelpers)), 32, // eslint-disable-line no-magic-numbers
