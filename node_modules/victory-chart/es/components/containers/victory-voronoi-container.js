  ...
  return _temp = _class = function (_base) {
    ...
    _createClass(VictoryVoronoiContainer, [{
      ...
      value: function getLabelPosition(props, points, labelProps) {
        ...
        var basePosition = Helpers.scalePoint(props, _omit(points[0], ["_voronoiX", "_voronoiY"]));
      ...
      value: function getLabelProps(props, points) {
        ...
        var text = points.reduce(function (memo, point) {
          var t = Helpers.evaluateProp(labels, point, true);
        ...
        var labelProps = _defaults({
          active: true,
          datum: _omit(points[0], ["childName", "style", "continuous"]),
    ...
    eventHandlers: {
      ...
      onMouseMove: function (evt, targetProps) {
        var mutations = VoronoiHelpers.onMouseMove(evt, targetProps);
