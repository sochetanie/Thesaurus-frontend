...
var SelectionHelpers = {
  ...
  onMouseUp: function (evt, targetProps) {
    ...
    var callbackMutation = selectedData && _isFunction(targetProps.onSelection) ? targetProps.onSelection(selectedData, bounds) : {};
    ...
    var dataMutation = selectedData ? selectedData.map(function (d) {
      return {
...
export default {
  ...
  onMouseMove: _throttle(attachId(SelectionHelpers.onMouseMove.bind(SelectionHelpers)), 16, // eslint-disable-line no-magic-numbers
