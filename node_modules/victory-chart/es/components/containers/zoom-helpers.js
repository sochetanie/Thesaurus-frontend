...
var Helpers = {
  ...
  getLastDomain: function (targetProps, originalDomain) {
    ...
    if (zoomDomain && !_isEqual(zoomDomain, cachedZoomDomain)) {
  ...
  getDomain: function (props) {
    ...
    if (childComponents.length) {
      childrenDomain = dimension ? _defineProperty({}, dimension, Wrapper.getDomainFromChildren(props, dimension, childComponents)) : {
  ...
  onWheel: function (evt, targetProps, eventKey, ctx) {
    ...
    || targetProps.zoomActive && !_isEqual(originalDomain, lastDomain);
...
export default {
  ...
  onWheel: _throttle(attachId(Helpers.onWheel.bind(Helpers)), 16, // eslint-disable-line no-magic-numbers
  { leading: true, trailing: false })
};