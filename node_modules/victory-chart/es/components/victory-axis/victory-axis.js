...
import { PropTypes as CustomPropTypes, Helpers, VictoryLabel, VictoryContainer, VictoryTheme, Line, TextSize, addEvents } from "victory-core";
...
VictoryAxis.defaultProps = {
  axisComponent: React.createElement(Line, { type: "axis" }),
  ...
  gridComponent: React.createElement(Line, { type: "grid" }),
  scale: "linear",
  standalone: true,
