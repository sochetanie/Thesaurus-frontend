  ...
  return _temp = _class = function (_base) {
    ...
    eventHandlers: {
      onMouseDown: function (evt, targetProps) {
        return _selectionHelpers2.default.onMouseDown(evt, targetProps);
      },
      onMouseMove: function (evt, targetProps) {
        var mutations = _selectionHelpers2.default.onMouseMove(evt, targetProps);
      ...
      onMouseUp: function (evt, targetProps) {
        return _selectionHelpers2.default.onMouseUp(evt, targetProps);
      }
    }
  }], _temp;
};
