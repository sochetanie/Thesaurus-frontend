...
var voronoiContainerMixin = exports.voronoiContainerMixin = function (base) {
  var _class, _temp;
  ...
  return _temp = _class = function (_base) {
    ...
    eventHandlers: {
      onMouseLeave: function (evt, targetProps) {
        return _voronoiHelpers2.default.onMouseLeave(evt, targetProps);
      },
      onMouseMove: function (evt, targetProps) {
        var mutations = _voronoiHelpers2.default.onMouseMove(evt, targetProps);
