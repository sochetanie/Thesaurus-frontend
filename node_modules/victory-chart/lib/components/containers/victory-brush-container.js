  ...
  return _temp = _class = function (_base) {
    ...
    _createClass(VictoryBrushContainer, [{
      ...
      value: function getSelectBox(props, coordinates) {
        ...
        return x[0] !== x[1] && y[0] !== y[1] ? _react2.default.cloneElement(selectionComponent, {
      ...
      value: function getRect(props) {
        ...
        var domain = (0, _isEqual3.default)(selectedDomain, cachedSelectedDomain) ? (0, _defaults3.default)({}, currentDomain, selectedDomain) : selectedDomain;
    ...
    selectedDomain: _propTypes2.default.shape({
    ...
    eventHandlers: {
      onMouseDown: function (evt, targetProps) {
        return _brushHelpers2.default.onMouseDown(evt, targetProps);
      },
      onMouseMove: function (evt, targetProps) {
        var mutations = _brushHelpers2.default.onMouseMove(evt, targetProps);
      ...
      onMouseUp: function (evt, targetProps) {
        return _brushHelpers2.default.onMouseUp(evt, targetProps);
      },
      onMouseLeave: function (evt, targetProps) {
        return _brushHelpers2.default.onMouseLeave(evt, targetProps);
      }
    }
  }], _temp;
};
