...
export default {
  ...
  getDomainWithZero: function (props, axis) {
    ...
    var ensureZero = function (domain) {
      ...
      var min = Collection.getMinValue(domain, 0);
      var max = Collection.getMaxValue(domain, 0);
  ...
  getDomainFromData: function (props, axis, dataset) {
    ...
    var allData = _flatten(dataset).map(function (datum) {
    ...
    var min = Collection.getMinValue(allData);
