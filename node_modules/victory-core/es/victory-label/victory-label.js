...
var VictoryLabel = function (_React$Component) {
  ...
  _createClass(VictoryLabel, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      if (!Collection.allSetsEqual([[angle, nextProps.angle], [className, nextProps.className], [x, nextProps.x], [y, nextProps.y], [dx, this.dx], [dy, this.dy], [lineHeight, this.lineHeight], [textAnchor, this.textAnchor], [transform, this.transform], [content, this.content], [style, this.style], [datum, nextProps.datum]])) {
