...
var areVictoryPropsEqual = function (a, b) {
  var checkEquality = function (o1, o2) {
    ...
    var keys1 = (0, _keys3.default)(o1);
    var keys2 = (0, _keys3.default)(o2);
    ...
    return keys1.reduce(function (equal, key) {
      ...
      if ((0, _isPlainObject3.default)(val1) || Array.isArray(val1) && !(0, _isEmpty3.default)(val1)) {
        return checkEquality(val1, val2);
      } else if ((0, _isFunction3.default)(val1)) {
        // isEqual does not support equality checking on functions,
        // so just check that both are functions
        return (0, _isFunction3.default)(val2);
      } else {
    ...
    _createClass(addEvents, [{
      ...
      value: function getStateChanges(props, calculatedValues) {
        ...
        var getState = function (key, type) {
          var result = (0, _defaults3.default)({}, _this2.getEventState(key, type), getSharedEventState(key, type));
          return (0, _isEmpty3.default)(result) ? undefined : result;
        };
